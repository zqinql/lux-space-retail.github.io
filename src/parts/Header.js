        ...
        <div className="flex flex-stretch items-center">
          ...
          <div className="w-auto">
            <ul className="items-center flex">
              ...
              <li className="ml-6">
                <Link
                  className={[theme === 'white' ? "flex items-center justify-center w-8 h-8 text-black md:text-white" : "flex items-center justify-center w-8 h-8 text-white md:text-black"]}
                  to='/cart'
                >
                  <svg
                    className="fill-current"
